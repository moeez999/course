                ...
                <div class="rightSide">
                    ...
                    <div class="row02">
                        <div class="row02_leftSide">
                            ...
                            <div class="threeDots userOptionOpen mobile">
                        ...
                        <div class="row02_rightSide">
                            <div class="threeDots userOptionOpen desktop">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M3 10H7V14H3V10ZM10 10H14V14H10V10ZM21 10H17V14H21V10Z" fill="#121117" />
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="card_leftSide selectGroupBTN">
                                        <p><?php echo $finalUpcoming12[$i]['date']; ?></p>
                                        <h1><?php echo $finalUpcoming12[$i]['day_time']; ?></h1>
...
">
    ...
    str_contains($finalUpcoming12[$i]['short_text']['title'], '1 on 1')
            ...
            `;
                                            ...
                                            div.className = 'date';
                                            div.innerHTML =
                                                `<div class='day gray'><h1>${day}</h1></div>`;
                                            scheduleContainer.appendChild(div);
                                        }
                                    });
                ...
                ?>
                    ...
                    <div class="schedule">
                        ...
                        <div class="row" id="schedule-container">
                            <div id="default-schedule" style="display: flex; flex-wrap: wrap; gap: 16px;">
                                <?php
                            foreach ($dayOrder as $day) {
